    ...
    <div>
      ...
      <div className="faqMainContent">
        ...
        <div className="faqText">
          ...
          <br />
          - $1200 (plus applicable sales Colorado sales tax). This includes FedEx shipping.
          <br />
          <br />
          ...
          contract for you to sign. Payments are split into three increments. You and I will
          ...
          Please send me an email at contact@laurenvoigtfinearts.com to get the
